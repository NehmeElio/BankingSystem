...
using Npgsql;
using IBranchSchemaService = TransactionService.Persistence.Interfaces.IBranchSchemaService;
...
public class BranchSchemaService : IBranchSchemaService
    {
        ...
        public void CreateBranchSchema(string newBranchName, string sourceSchemaName = "beirutbranch")
        {
            ...
            var recurrentTable="\"RecurrentTransaction\"";
                ...
                try
                {
                    ...
                    var copyTablesCmd = $@"
                            ...
                            BEGIN
                                ...
                                LOOP
                                    EXECUTE format('CREATE TABLE {newBranchName}.%I (LIKE {sourceSchemaName}.%I INCLUDING ALL);', r.tablename, r.tablename);
                                END LOOP;
                            END
                            $$;";
                    ...
                    var grantPermissionsCmd = $@"
                            ...
                            BEGIN
                               ...
                               EXECUTE 'GRANT SELECT,INSERT,UPDATE ON {newBranchName}.{transactionTable} TO {newBranchName}_customer;';
                               EXECUTE 'GRANT SELECT ON {newBranchName}.{recurrentTable} TO {newBranchName}_customer;';
